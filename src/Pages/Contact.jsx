            ...
            <div className="col-xxl-6 col-lg-7">
              ...
              <div className="row cs_gap_y_30 cs_row_gap_30">
                <ContactCard
                  ...
                  Title="Our Address"
                  Content="12 The Fairway Hampton Park VIC 3976"
                ></ContactCard>
                <ContactCard
                  img="/assets/img/icons/contact_icon_2.svg"
                  Title="Phone Number"
                  Content="0405 133 761"
                ></ContactCard>
                <ContactCard
                  img="/assets/img/icons/contact_icon_3.svg"
                  Title="Email Address"
                  Content="faisalexpertise@gmail.com <br>nihaanexpertise@gmail.com"
                ></ContactCard>
                <ContactCard
                  img="/assets/img/icons/contact_icon_4.svg"
                  Title="Working Time"
                  Content="Work Time: Sat - Fri <br>08AM - 08PM"
                ></ContactCard>
              </div>
