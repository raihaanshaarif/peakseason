            ...
            <div className="col-lg-8">
              <div className="cs_pr_30">
                <div className="cs_service_details">
                  <img
                    src="/assets/img/split-systems-img.jpg"
                    alt="Split System Service"
                  />
                  <h2 className="cs_fs_48 cs_mb_20">
                    Split System Air Conditioning Experts
                  </h2>
                  <p className="cs_mb_25">
                    Enjoy year-round comfort with our professional split system
                    air conditioning services. We specialise in the
                    installation, repair, and maintenance of split systems for
                    homes and businesses across Melbourne. Our experienced
                    technicians ensure your system is perfectly matched to your
                    space and delivers efficient, quiet, and reliable
                    performance.
                  </p>
                  ...
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      ...
                      Efficient heating and cooling for single rooms or
                      open-plan areas
                    </li>
                    <li>
                      <svg
                      ...
                      Quiet operation and sleek, modern design
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Energy-efficient and cost-effective climate control
                    </li>
                    <li>
                      <svg
                        width="16"
                  ...
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      ...
                      Expert installation for all leading brands and models
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Fast repairs and troubleshooting for any issue
                    </li>
                    <li>
                      <svg
                        width="16"
