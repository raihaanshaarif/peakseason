...
const Repairs = () => {
  ...
  return (
    <div className="service-details">
      <BreadCumb Title="Repairs Service" />
      <section>
              ...
              <div className="cs_pr_30">
                <div className="cs_service_details">
                  ...
                  <h2 className="cs_fs_48 cs_mb_20">
                    Expert Repairs for All Systems
                  </h2>
                  <p className="cs_mb_25">
                    Restore comfort and efficiency with our professional repair
                    services for all types of air conditioning, heating, and
                    cooling systems. We repair split systems, ducted air
                    conditioning, hydronic heating, evaporative coolers, wall
                    furnaces, and more. Our experienced technicians quickly
                    diagnose and fix faults to get your system running smoothly
                    again.
                  </p>
                  ...
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      ...
                      Fast response and reliable repairs for all brands
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Experienced, licensed, and insured technicians
                    </li>
                    <li>
                      <svg
                        width="16"
                    ...
                    <li>
                      ...
                      Repairs for split, ducted, hydronic, evaporative, and
                      heater systems
                    </li>
                  </ul>
                  <h3 className="cs_fs_30 cs_mb_15">
                  ...
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    ...
                    <li>
                      ...
                      Faulty thermostats, controls, and sensors
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Leaks, blockages, and airflow issues
                    </li>
                    <li>
                      <svg
                        width="16"
                  ...
                  <h3 className="cs_fs_30 cs_mb_15">
                    What Are the Benefits of Professional Repairs?
                  </h3>
