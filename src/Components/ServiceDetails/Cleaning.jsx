...
const Cleaning = () => {
  ...
  return (
    <div className="service-details">
      <BreadCumb Title="Cleaning Service" />
      <section>
              ...
              <div className="cs_pr_30">
                <div className="cs_service_details">
                  ...
                  <h2 className="cs_fs_48 cs_mb_20">
                    Professional Cleaning for All Systems
                  </h2>
                  <p className="cs_mb_25">
                    Ensure your air conditioning, heating, and cooling systems
                    run efficiently and provide healthy air with our
                    comprehensive cleaning services. We offer expert cleaning
                    for split systems, ducted air conditioning, hydronic
                    heating, evaporative coolers, wall furnaces, and more. Our
                    team removes dust, dirt, allergens, and contaminants to
                    improve air quality, system performance, and energy
                    efficiency.
                  </p>
                  ...
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    ...
                    <li>
                      ...
                      Boosts system efficiency and lowers energy bills
                    </li>
                    <li>
                      <svg
                        width="16"
                  ...
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      ...
                      Split system, ducted, evaporative, and hydronic cleaning
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Filter replacement and sanitisation
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Duct and vent cleaning for improved airflow
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Wall furnace and space heater cleaning
                    </li>
                  </ul>
                  <h3 className="cs_fs_30 cs_mb_15">
