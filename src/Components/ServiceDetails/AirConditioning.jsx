...
const AirConditioning = () => {
  ...
  return (
    <div className="service-details">
      <BreadCumb Title="Air Conditioning" />
      <section>
          ...
          <div className="row cs_gap_y_60">
            <div className="col-lg-8">
              <div className="cs_pr_30">
                <div className="cs_service_details">
                  <img
                    src="/assets/img/service_details_1.jpg"
                  ...
                  <p className="cs_mb_25">
                    Stay comfortable all year round with our expert air
                    conditioning services. Whether you need installation,
                    repair, or maintenance, our certified technicians deliver
                    reliable solutions tailored to your home or business. We use
                    only the latest technology and proven methods to ensure your
                    system runs efficiently, quietly, and cost-effectively.
                  </p>
                  <h3 className="cs_fs_30 cs_mb_15">
                    Why Choose Our Air Conditioning Service?
                  </h3>
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      ...
                      Fast, professional installation for all major brands and
                      models
                    </li>
                    <li>
                      <svg
                      ...
                      Comprehensive repairs and diagnostics to restore comfort
                      quickly
                    </li>
                    <li>
                      <svg
                      ...
                      Preventative maintenance for efficiency, longevity, and
                      lower bills
                    </li>
                    <li>
                      <svg
                      ...
                      Friendly, local experts dedicated to your comfort and
                      satisfaction
                    </li>
                  </ul>
                  <h3 className="cs_fs_30 cs_mb_15">
                    The Necessity of Professional Air Conditioning
                  </h3>
                  <p className="cs_mb_25">
                    Melbourne’s climate can be unpredictable, making a reliable
                    air conditioning system essential for comfort and
                    productivity. Professional installation and regular
                    servicing not only ensure optimal performance but also help
                    you avoid costly breakdowns, reduce energy bills, and
            ...
            <div className="col-lg-4">
              <div className="cs_right_sidebar">
                ...
                <div className="cs_sidebar_widget2">
                  <Form2></Form2>
                </div>
              </div>
            </div>
