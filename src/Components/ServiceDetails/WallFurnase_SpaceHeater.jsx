...
const WallFurnase_SpaceHeater = () => {
  ...
  return (
    <div className="service-details">
      <BreadCumb Title="Wall Furnace / Space Heater" />
      <section>
            ...
            <div className="col-lg-8">
              <div className="cs_pr_30">
                <div className="cs_service_details">
                  <img
                    src="/assets/img/space-heaters-img.jpg"
                    alt="Wall Furnace / Space Heater Service"
                  />
                  <h2 className="cs_fs_48 cs_mb_20">
                    Wall Furnace & Space Heater Specialists
                  </h2>
                  <p className="cs_mb_25">
                    Stay warm and comfortable with our expert wall furnace and
                    space heater services. We provide professional installation,
                    maintenance, repair, and servicing for all types of wall
                    furnaces and space heaters in Melbourne homes and
                    businesses. Our experienced team ensures your heating system
                    is safe, efficient, and reliable throughout the colder
                    months.
                  </p>
                  <h3 className="cs_fs_30 cs_mb_15">
                    Why Choose a Wall Furnace or Space Heater?
                  </h3>
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      ...
                      Fast, effective heating for individual rooms or small
                      spaces
                    </li>
                    <li>
                      <svg
                      ...
                      Compact design and easy wall installation
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Energy-efficient heating with modern safety features
                    </li>
                    <li>
                      <svg
                        width="16"
                      ...
                      Ideal for bedrooms, living rooms, offices, and more
                    </li>
                  </ul>
                  <h3 className="cs_fs_30 cs_mb_15">
                    Our Wall Furnace & Space Heater Services
                  </h3>
                  <ul className="cs_list cs_style_1 cs_mp_0 cs_fs_18 cs_medium cs_heading_font">
                    <li>
                      <svg
                      ...
                      Professional installation for all leading brands
                    </li>
                    <li>
                      <svg
                        width="16"
                    ...
                    <li>
                      ...
                      Fast repairs and troubleshooting for all models
                    </li>
                    <li>
                      <svg
                        width="16"
                  ...
                  <h3 className="cs_fs_30 cs_mb_15">
                    What Are the Benefits of Wall Furnace / Space Heater?
                  </h3>
...
export default WallFurnase_SpaceHeater;
